        ...
        <section id="contact" class="contact">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-7">
                        ...
                        <input type="text" name="product_name" class="form-control" id="name"
                               maxlength="25" size="30" placeholder="${funding.product_name }" required>
                    </div>
                </div>
                <!-- 마감일 -->
                <div class="row mt-2">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-7">
                        <input name="goal_money" class="form-control" id="name"
                               type="number" value="${funding.goal_money }" size="30" readonly >
                    </div>
                </div>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-2">
                            <input type="text" id="reward_price" name="reward_price" class="form-control" maxlength="6"
                                   oninput="maxLengthCheck(this)" placeholder="최대 90만원까지 입력 가능합니다." required>
                        </div>
                        <div class="col-2">
                            <input class="col center btn btn-primary" type="button" value="추가" onclick="add_div()" style="margin-left: 34% ">
                            <input class="col center btn btn-danger" type="button" value="삭제" onclick="remove_div(this)" style="margin: 0 auto">
                        </div>
                    </div>
                </div>
                <div id="field"></div>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-7">
        <textarea class="form-control" name="content" rows="5" placeholder="${funding.content }"
                  required></textarea>
                    </div>
                </div>
                <br>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-5 pt-1">
                        ...
                        <input type="button" class="btn btn-secondary" value="목록으로 이동" onclick="location.href='/board/getFundingList'">
                    </div>
                </div>
                <hr class="mt-5">
            </div>
